...
function calcularCostoCombustible() {
    ...
    do {
        let distanciaViaje = parseFloat(prompt("Ingresá la distancia de tu viaje (en kilómetros, utiliza solo números)"));
        let precioCombustible = parseFloat(prompt("Ingresá el precio del litro de combustible (sin el signo $, solo números)"));
        let rendimientoAuto = parseFloat(prompt("Ingresá el rendimiento de tu auto por litro (en kilómetros por litro, utiliza solo números)"));
